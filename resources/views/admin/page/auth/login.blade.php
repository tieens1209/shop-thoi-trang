...
<link rel="stylesheet" href="{{ asset('assets/client/css/styles.min.css') }}" />
    ...
    <div class="row justify-content-center w-100">
        ...
        <div class="card mb-0">
            ...
            <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                <img src="https://routine.vn/media/amasty/webp/logo/websites/1/logo-black-2x_png.webp" width="180" alt="">
            </a>
