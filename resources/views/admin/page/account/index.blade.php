                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        <h5 class="card-title fw-semibold mb-4 mt-5">Tài khoản</h5>
                            ...
                            <a href="{{ route('admin.account.create') }}"><button type="submit" class="btn btn-success m-1">Tạo tài
                                    khoản</button></a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($accounts as $account)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <p class="mb-0 fw-normal">{{ $account->name }}</p>
                                            </td>
                                            <td class="border-bottom-0">
                                            ...
                                            <td class="border-bottom-0" style="display: flex;">
                                                @if (is_null($account->deleted_at))
                                                        ...
                                                        <a href="{{ route('admin.account.edit', $account->id) }}"><button
