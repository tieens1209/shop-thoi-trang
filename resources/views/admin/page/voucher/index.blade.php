                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        <h5 class="card-title fw-semibold mb-4 mt-5">Mã giảm giá</h5>
                            ...
                            <a href="{{ route('admin.voucher.create') }}"><button type="submit" class="btn btn-success m-1">Thêm mã giảm giá</button></a>
                                    ...
                                    @foreach ($vouchers as $voucher)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0" style="display: flex;">
                                                    ...
                                                    <a href="{{ route('admin.voucher.edit', $voucher->id) }}"><button type="submit"
