...
class OrderController extends Controller
{
    ...
    public function viewCart()
    {
        ...
        return view('client.page.order.cart', compact('carts', 'totalBill'));
    }
        ...
        if (!is_null($voucher)) {
            ...
            if ($voucher->number > 0) {
                ...
                if ($nowDay >= $voucher->dateStart && $nowDay < $voucher->dateEnd) {
                    ...
                    return view('client.page.order.checkOut', compact('user', 'carts', 'voucher', 'totalBill'));
                } else {
    ...
    public function getFormCheckOut()
    {
        ...
        return view('client.page.order.checkOut', compact('user', 'carts', 'totalBill'));
    }
    ...
    public function completePayment(Request $request)
    {
        ...
        if ($request->payment != null && $request->payment == 0) {
            ...
            return view('client.page.order.completePayment');
        }
    ...
    public function listOrder()
    {
        ...
        return view('client.page.order.listOrder', compact('orders'));
    }
    public function detailOrder($id)
    {
        ...
        return view('client.page.order.detailOrder', compact('user', 'products', 'order'));
    }
}